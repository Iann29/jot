...
curl -L -o jot.tar.gz https://github.com/Iann29/jot/releases/latest/download/jot-v0.3.0-x86_64-linux.tar.gz
tar -xzf jot.tar.gz && cd jot-v0.3.0-x86_64-linux && ./install.sh
```
