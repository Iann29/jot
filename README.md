...
curl -L -o jot.tar.gz https://github.com/Iann29/jot/releases/download/v1.7.1/jot-v1.7.1-x86_64-linux.tar.gz
tar -xzf jot.tar.gz && cd jot-v1.7.1-x86_64-linux && ./install.sh
```
...
Grab `jot-v1.7.1-x86_64-windows.zip` from the [latest release](https://github.com/Iann29/jot/releases/latest), unzip it anywhere, and run `jot.exe`.
