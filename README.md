...
curl -L -o jot.tar.gz https://github.com/Iann29/jot/releases/latest/download/jot-v1.1.0-x86_64-linux.tar.gz
tar -xzf jot.tar.gz && cd jot-v1.1.0-x86_64-linux && ./install.sh
```
