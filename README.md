...
curl -L -o jot.tar.gz https://github.com/Iann29/jot/releases/download/v1.4.1/jot-v1.4.1-x86_64-linux.tar.gz
tar -xzf jot.tar.gz && cd jot-v1.4.1-x86_64-linux && ./install.sh
```
